...
public class PromedioRespuestaConsultaClientes implements Operacion {
    ...
    public void explicarIndice() {
        // Explica tu indice
        System.out.println(
                "Se encarga de calcular el promedio de respuesta por consulta y guardar este valor en una hoja de cálculo de Excel."
