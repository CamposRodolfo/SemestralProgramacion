...
public class IndiceCapacitacionDesarrollo implements Operacion {
  ...
  public void guardarValor(double valor) {
    try {
      ...
      Excel.escribirCelda(HOJA, FILA, 3, valor);
    } catch (IOException e) {
      e.printStackTrace();
    }
  }
