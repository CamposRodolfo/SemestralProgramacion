...
public class Humanos implements Departamento {
   ...
   public Operacion obtenerOperacion() {
        ...
        Menu<OperacionesRH> menuOperaciones = new Menu<>(OperacionesRH.values());

        // operacionSeleccionada almacenará la opción que ingrese el usuario dentro del
        // menú de RH
        OperacionesRH operacionSeleccionada = menuOperaciones.obtenerValor("Operaciones del Departamento de Finanzas",
